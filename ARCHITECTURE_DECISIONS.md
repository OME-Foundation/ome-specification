...
| --- | --- | --- | --- |
| Project authority | Merged Git content is canonical; open PRs are proposals; chat is working context; memory is non-authoritative. | Proposed | [PR #2](https://github.com/OME-Foundation/ome-specification/pull/2) |
| Contributor continuity | Humans and AI agents are replaceable and should recover project context from repository records. | Proposed | [PR #2](https://github.com/OME-Foundation/ome-specification/pull/2) |
...
| Phase 1 research records | Claims, evidence and research items use stable related identifiers and explicit decision rules. | Proposed | [PR #1](https://github.com/OME-Foundation/ome-specification/pull/1) |
